  ...
  return (
    <div>
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="bg-[url('src/assets/img/Services-bg.jpg')] bg-cover bg-no-repeat lg:bg-[center_bottom_-100px] sm:h-[300px] md:h-[400px] lg:h-[540px] flex items-end justify-center"
      >
