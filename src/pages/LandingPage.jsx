...
const LandingPage = () => {
  return (
    <div>
      <Helmet>
        <title>Molave Street Barbers</title>
        <meta name="description" content="Molave Barbershop offers expert haircuts, grooming, and premium styling services tailored for men who value their look."/>
        <meta name="keywords" content="barbershop, molave barbershop, haircut, men's grooming, styling, molave"/>
      </Helmet>
