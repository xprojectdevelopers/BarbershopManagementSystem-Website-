...
const LandingPage = () => {
  useEffect(() => {
    document.title = "Molave Street Barbers";
    document
      .querySelector('meta[name="description"]')
      ?.setAttribute("content", "Experience the best haircuts and grooming services in Molave. Walk in style, walk with confidence.");
    document
      .querySelector('meta[name="keywords"]')
      ?.setAttribute("content", "barbershop, haircut, grooming, Molave, style, men haircut");
  }, []);
  ...
  return (
    <div className='mb-[-25px] scroll-smooth'>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className='bg-[url("/src/assets/img/Hero-bg.jpg")] bg-cover bg-center lg:bg-position-[center_top_calc(65%-1rem)] bg-no-repeat h-[200px] sm:h-[300px] md:h-[400px] lg:h-[685px] flex items-end justify-center'
        >
        ...
        >
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:w-[83%] 2xl:w-[70%] tracking-[0.4px] text-center text-base justify-center items-center'>
            ...
            <div className='mb-4'>
              <img src={grid2} alt="Hair Wash" loading='lazy' className='mb-2 h-90'/>
              <h6>Hair Wash</h6>
            </div>
            <div className='mb-4'>
              <img src={grid3} alt="Hot Towel" loading='lazy' className='mb-2 h-90'/>
              <h6>Hot Towel</h6>
            </div>
            <div className='mb-4'>
              <img src={grid4} alt="Shave" loading='lazy' className='mb-2 h-90'/>
              <h6>Shave</h6>
            </div>
          </div>
          ...
          <div className='flex flex-wrap justify-center gap-4 mt-8 lg:mt-10 tracking-[0.4px]' style={{fontFamily: 'satoshi-medium'}}>
            <div className='text-center text-sm lg:text-base flex flex-col gap-2'>
              <div className='lg:mb-4'>
                <img src={M1} alt="Connect With Us" loading='lazy' className='h-120'/>
              </div>
            ...
            <div className='text-center text-sm lg:text-base flex flex-col gap-2 mt-4 lg:mt-0'>
              ...
              <a href="https://github.com/xprojectdevelopers/BarbershopManagementSystem-Mobile/releases/download/Mobile_App/application-36f9156f-cae0-4276-8cc1-469ec416b0c0.apk" className='underline'>MLV ST. (Get App)</a>
            </div>
            <div className='text-center text-sm lg:text-base flex flex-col gap-2 mt-4 lg:mt-0'>
              <div className='lg:mb-4'>
                <img src={M3} alt="Tell Us" loading='lazy' className='h-120'/>
              </div>
