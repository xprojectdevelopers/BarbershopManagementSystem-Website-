...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-normal transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default:
          "bg-background border-1 border-black rounded-full w-[118px] text-sm md:text-base hover:bg-gray-100 transition duration-300 dark:hover:bg-accent/50 dark:hover:text-accent-foreground",
        orig:
          "bg-background border-1 border-black rounded-full w-[164px] text-sm md:text-base hover:bg-gray-200 dark:hover:bg-accent/50 dark:hover:text-accent-foreground",
      ...
      size: {
        default: "h-8 md:h-10 px-4 py-2 has-[>svg]:px-3",
        sm: "h-10 md:h-12 rounded-full gap-1.5 px-3 has-[>svg]:px-2.5",
        lg: "h-12 md:h-15 rounded-full px-6 has-[>svg]:px-4",
        icon: "size-9",
      },
    },
    defaultVariants: {
